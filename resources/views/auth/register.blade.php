...
<head>
    <title>Register Page Admin PTNBH Untan</title>
            ...
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    <div class="app-auth-branding mb-4"><a class="app-logo" href="index.html"><img
                                ...
                                alt="logo"></a></div>
                    <h2 class="auth-heading text-center mb-4">Sign up to Admin PTNBH Untan</h2>

                    <div class="auth-form-container text-start mx-auto">
                        <form class="auth-form auth-signup-form" action="/auth/register" method="POST">
                            @csrf
