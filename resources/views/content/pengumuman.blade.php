...
@section('content')
    ...
    <script>
        assetUrl = "{{ asset('images/pengumuman') }}";
        $(document).ready(function() {
            var table = $('#pengumuman-list').DataTable({
                processing: false,
                serverSide: true,
                searching: true,
                info: false,
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return '<img src="' + assetUrl + '/' + data +
                                '" alt="Gambar Pengumuman" style="max-width: 100px;">';
                        }
                    },
                    {
                        data: 'judul',
            ...
            $('body').on('click', '.deletePengumuman', function() {
                var pengumuman_id = $(this).data("id");
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "DELETE",
                            url: "{{ route('pengumuman.index') }}" + '/' + pengumuman_id,
                            headers: {
            ...
            $('body').on('click', '.editPengumuman', function() {
                var pengumuman_id = $(this).data('id');
                window.location.href = 'pengumuman/' + pengumuman_id + '/edit';
            });
