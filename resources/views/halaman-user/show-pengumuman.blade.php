...
@section('content')
    ...
    <section class="hero-profile"
        ...
        <div class="row">
            <h1 class="profile-1"><span style="color: #ffea00;">|</span> Pengumuman </h1>
                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        <div class="article-img">
                            <img src="{{ asset('/images/pengumuman/' . $pengumuman->gambar) }}" alt="Gambar pengumuman">
                        </div>
                        <div class="article-title">
                            <!-- <h6><a href="#">Lifestyle</a></h6> -->
                            <h2>{{ strip_tags($pengumuman->judul) }}</h2>
                            <div class="media">
                                <div class="media-body">
                                    <span>{{ strip_tags($pengumuman->created_at) }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="article-content">
                            {!! str_replace('pola_pencarian', 'pengganti', $pengumuman->konten) !!}
                        </div>
                    </article>
