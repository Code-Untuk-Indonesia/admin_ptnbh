                        ...
                        <div class="app-card-body px-4 w-100">
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        <div class="item-label mb-2"><strong>Foto Profil</strong></div>
                                        <div class="item-data">
                                            <img class="profile-image" src="{{ $user->foto ? asset('images/profile/'.$user->foto) : asset('images/profile/blank.jpg') }}" alt="">
                                        </div>
                                    </div><!--//col-->
                                    <div class="col text-end">
                                        <a class="btn-sm app-btn-secondary" href="#" data-bs-toggle="modal" data-bs-target="#changePhotoModal">Change</a>
                                    </div><!--//col-->
                                </div><!--//row-->
                            </div><!--//item-->
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col text-end">
                                        <a class="btn-sm app-btn-secondary" href="#" data-bs-toggle="modal" data-bs-target="#changeNameModal">Change</a>
                                    </div><!--//col-->
                                </div><!--//row-->
                            </div><!--//item-->
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col text-end">
                                        <a class="btn-sm app-btn-secondary" href="#" data-bs-toggle="modal" data-bs-target="#changeEmailModal">Change</a>
                                    </div><!--//col-->
                                </div><!--//row-->
                            </div><!--//item-->
                        </div><!--//app-card-body-->
                        ...
                        <div class="app-card-body px-4 w-100">
                            <div class="item border-bottom py-3">
                                <div class="row justify-content-between align-items-center">
                                    ...
                                    <div class="col text-end">
                                        <a class="btn-sm app-btn-secondary" href="#" data-bs-toggle="modal" data-bs-target="#changePasswordModal">Change</a>
                                    </div><!--//col-->
                                </div><!--//row-->
                            </div><!--//item-->
                        </div><!--//app-card-body-->
...
<div class="modal fade" id="changePhotoModal" tabindex="-1" aria-labelledby="changePhotoModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Add delete photo form -->
            <form method="POST" action="{{ route('profile.delete.photo') }}" class="w-100 mt-2">
                @csrf
                @method('DELETE')
                <div class="modal-footer">
                    <button type="submit" class="btn btn-danger w-100">Hapus Foto</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{ route('profile.update.name') }}">
                ...
                @method('PUT')
                <div class="modal-header">
                    <h5 class="modal-title" id="changeNameModalLabel">Ubah Nama</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="name" class="form-label">Masukkan Nama Baru</label>
