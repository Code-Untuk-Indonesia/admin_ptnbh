                    ...
                    <div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
                        ...
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                            <div class="app-card-body">
                                <h5 class="mb-4">Tentang - Indonesia</h5>
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="cell">{{ $data->judul_sejarah_id }}</td>
                                                <td class="cell">{{ $data->isi_sejarah_id }}</td>
                                                <td class="cell">{{ $data->visi_id }}</td>
                                                <td class="cell">{{ $data->misi_id }}</td>
                                                <td class="cell">{{ $data->judul_tujuan_id }}</td>
                                                <td class="cell">{{ $data->tujuan_id }}</td>
                                                <td class="cell">
                        ...
                        <div class="app-card app-card-orders-table shadow-sm mb-5">
                            <div class="app-card-body">
                                <h5 class="mb-4">Tentang - Inggris</h5>
                                <div class="table-responsive">
                                    <table class="table app-table-hover mb-0 text-left">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            {{-- @foreach ($data as $item) --}}
                                            <tr>
                                                <td class="cell">{{ $data->judul_sejarah_en }}</td>
                                                <td class="cell">{{ $data->isi_sejarah_en }}</td>
                                                <td class="cell">{{ $data->visi_en }}</td>
                                                <td class="cell">{{ $data->misi_en }}</td>
                                                <td class="cell">{{ $data->judul_tujuan_en }}</td>
                                                <td class="cell">{{ $data->tujuan_en }}</td>
                                                <td class="cell">
                                                    <a class="btn btn-sm app-btn-secondary" href="{{ route('tentang.edit', $data->id) }}">Edit</a>
                                                </td>
                                            </tr>
